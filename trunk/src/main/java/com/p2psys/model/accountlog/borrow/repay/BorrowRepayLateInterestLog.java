 ...
 * @since 2013-9-5
 */
public class BorrowRepayLateInterestLog extends BaseBorrowLog{
	...
	private String templateNid=Constant.LATE_REPAYMENT;
	
	public BorrowRepayLateInterestLog() {
		super();
	}
	
	public BorrowRepayLateInterestLog(double money, Account act, long toUser) {
		super(money, act, toUser);
	}
	
	public BorrowRepayLateInterestLog(double money, Account act) {
		super(money, act);
	}

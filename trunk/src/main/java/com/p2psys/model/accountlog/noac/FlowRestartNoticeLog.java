...
public class FlowRestartNoticeLog extends BaseSimpleNoticeLog {
	...
	public FlowRestartNoticeLog() {
		super();
		// TODO Auto-generated constructor stub
	}

	public FlowRestartNoticeLog(double money, Account act, long toUser) {
		super(money, act, toUser);
		// TODO Auto-generated constructor stub
	}

	public FlowRestartNoticeLog(double money, Account act) {
		super(money, act);
		// TODO Auto-generated constructor stub
	}
	...
	public void sendNotice() {
		...
		noticeService.sendNotice(Constant.NOTICE_FLOW_RESTART, sendData);
	}*/
	//v1.6.7.1 RDPROJECT-314 liukun 2013-11-27 end
	private final static String noticeTypeNid = Constant.NOTICE_FLOW_RESTART;
	@Override

...
public class UserCertifyCancelLog extends BaseSimpleNoticeLog {
	...
	public UserCertifyCancelLog() {
		super();
		// TODO Auto-generated constructor stub
	}

	public UserCertifyCancelLog(double money, Account act, long toUser) {
		super(money, act, toUser);
		// TODO Auto-generated constructor stub
	}

	public UserCertifyCancelLog(double money, Account act) {
		super(money, act);
		// TODO Auto-generated constructor stub
	}
	
	public UserCertifyCancelLog(long user_id) {
		super();
	...
	public void sendNotice() {
		...
		noticeService.sendNotice(Constant.NOTICE_CERTIFY_CANCEL, sendData);
	}*/
	//v1.6.7.1 RDPROJECT-314 liukun 2013-11-27 end
	private final static String noticeTypeNid = Constant.NOTICE_CERTIFY_CANCEL;
	@Override

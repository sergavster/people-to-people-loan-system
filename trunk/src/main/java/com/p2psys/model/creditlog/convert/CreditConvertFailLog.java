 ...
 * @since 2013-10-18
 */
public class CreditConvertFailLog extends BaseCreditConvertLog {
	...
	private String logType = EnumCreditTemplateNid.CONVERT_FAIL.getValue();
	
	public CreditConvertFailLog() {
		super();
	}
	
	public CreditConvertFailLog(long op, long op_user, long credit_type, long user_id, long credit_value, long valid_value) {

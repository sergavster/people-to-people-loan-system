...
function createTabel(atop,aleft){
	...
	div.setAttribute( "id" , "div_id"); //���Ψһid
	sub_id = "sub_div"; //
	div.style.width   =   300; //����
	div.style.top   =  getScrollTop() + (document.body.scrollHeight-200)/2 -60; //����
	div.style.left   =   (document.body.scrollWidth-200)/2; //��߶�
	...
	+ " align='left' "
	+ '><strong style="font-size:13px"><a href="#" onclick="cle_div()">[�ر�]</a></strong></div> <div  '
	+ 'id="sub_div"'
	+ " style='"
	+ "width:100%;"
	+ "height:auto;"
	...
	//div.addEventListener("onmousedown",new Function("getFocus('"+sub_id+"')")); //����϶�����
	document.body.appendChild(div);
	var   div_sub   =   document.createElement("DIV"); //����div��

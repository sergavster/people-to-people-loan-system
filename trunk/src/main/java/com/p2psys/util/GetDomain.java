...
public class GetDomain {
	...
	public static void main(String[] args) {
		...
		//**********************这部分根据实际情况填写*******************************************
		String table_name = "dw_ca_trade_serial";//表名  
		String authorName = "liukun";//作者名字  
		String packageOutPath = "com.p2psys.domain";//指定实体生成所在包的路径 
		String folderPath = "E://";//生成文件路径
	    //数据库连接 
		String table_schema = "zhaosd";
		String user = "root";
		String password = "123456";
		String url = "jdbc:mysql://localhost/zhaosd?useUnicode=true&characterEncoding=utf8";		
		//**********************这部分根据实际情况填写*******************************************
		...
		try {
			...
			all.append(" * @since "+dateStr(new Date())+"\r\n");  
			all.append(" */ \r\n");  
	        //实体部分  
			all.append("public class " + className + " implements Serializable {\r\n");

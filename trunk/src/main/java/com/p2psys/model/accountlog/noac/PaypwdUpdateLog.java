...
public class PaypwdUpdateLog extends BaseSimpleNoticeLog {
	...
	public PaypwdUpdateLog() {
		super();
		// TODO Auto-generated constructor stub
	}

	public PaypwdUpdateLog(double money, Account act, long toUser) {
		super(money, act, toUser);
		// TODO Auto-generated constructor stub
	}

	public PaypwdUpdateLog(double money, Account act) {
		super(money, act);
		// TODO Auto-generated constructor stub
	}
	...
	public void sendNotice() {
		...
		noticeService.sendNotice(Constant.NOTICE_PAYPWD_UPDATE, sendData);
	}*/
	//v1.6.7.1 RDPROJECT-314 liukun 2013-11-27 end
	private final static String noticeTypeNid = Constant.NOTICE_PAYPWD_UPDATE;
	@Override

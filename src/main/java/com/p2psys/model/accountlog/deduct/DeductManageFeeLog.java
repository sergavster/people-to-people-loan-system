 ...
 * @since 2013-9-4
 */
public class DeductManageFeeLog extends DeductSuccessLog {
	 ...
	 * 类型：利息管理费
	 */
	private String templateNid = Constant.MANAGE_FEE;
	 ...
	 * @param toUser toUser
	 */
	public DeductManageFeeLog(double money, Account act, long toUser) {
	 ...
	 * @param act act
	 */
	public DeductManageFeeLog(double money, Account act) {
		super(money, act);
	}
